        ...
        class Effect {
            ...
            async setupText(isSkipGetFont) {
                ...
                if (isErrorMode) {
                    ...
                    gradient.addColorStop(0, isDarkMode ? '#061178' : '#C5FF95');
                    gradient.addColorStop(0.3, isDarkMode ? '#2251CC' : '#C5FF95');
                    gradient.addColorStop(0.6, isDarkMode ? '#061178' : '#C5FF95');
                    gradient.addColorStop(1, isDarkMode ? '#2251CC' : '#C5FF95');
                }
